...
*/
document.addEventListener("DOMContentLoaded", () => console.log("все теги прогруузились"));
...
parentElm.addEventListener("click", (event) =>{
    console.log(event.target.className === 'super_element');
...
textElm.addEventListener('mouseout', () => {
...
*/
const colorElm = document.querySelectorAll('li');
for (let index = 0; index < colorElm.length; index++) {
    if(index % 2 !==2 ) colorElm[index].style.backgroundColor = '#efefef';
